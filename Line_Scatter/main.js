...
trace1.textfont = {
    family: "Raleway, sans-serif", //設定字型
    size: 10
}
...
let layout = {
    ...
    title: 'Scatter & Line First PlotlyJS Chart',
    updatemenus: [
        {
            y: 1.2,
            x: 0.3,
